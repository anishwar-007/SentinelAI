...
from app.analysis.prompts import root_cause_analysis_prompt
from app.analysis.schemas import ComponentConfidence, RootCauseAnalysis
...
class RootCauseAnalyzer:
    ...
    @trace_span("root_cause_analysis")
    async def analyze(
        self,
        *,
        query: str,
